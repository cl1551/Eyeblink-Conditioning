function EBAOnline_main_v2_Trace()
...
h_Main.h_Video.ROIPosition = [240 80 248 179];%ROI of the video capture
...
%         h_Main.h_StartProtocol.Enable = 'off';
    ...
    function funFlashPuff()
        pause(.1);
        writeDigitalPin(h_Main.h_Arduino,'D3',1);   % Flash Blue Light On.
        pause(.05);
        writeDigitalPin(h_Main.h_Arduino,'D3',0);   % Flash Blue Light Off.
        pause(.27);
        if sectionNum < 10
